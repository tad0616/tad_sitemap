...
//---樣板設定---//
$i=0;
$modversion['templates'][$i]['file'] = 'tad_sitemap_adm_main.html';
$modversion['templates'][$i]['description'] = 'tad_sitemap_adm_main.html';
...
$i++;
$modversion['templates'][$i]['file'] = 'tad_sitemap_index.html';
$modversion['templates'][$i]['description'] = 'tad_sitemap_index.html';
